...
import 'package:hismobileapp/UI/ContactUs.dart';
...
/////////////
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Row(children: [
                                      ...
                                      Text(
                                        LanguageProvider.Llanguage("contactus"),
                                        style: ArabicTextStyle(
                                            arabicFont: ArabicFont.tajawal,
                                            fontSize: 17.5 * unitHeightValue,
                                            color:
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      Share.share(
                                          ...
                                          'https://play.google.com/store/apps/details?id=com.galaxygroup.hismobileapp');
                                    },
                                    child: Row(children: [
                                      Icon(
                                        Icons.share,
  ...
  Future<List<HospitalInfo>> getHospitalInf() async {
    ...
    Uri postsURL = Uri.parse(ip + Globalvireables.HospitalInfoURL);
